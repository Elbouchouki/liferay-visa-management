package com.liferay.gwenod.visa.validator.impl;
...
public class VisaValidatorImpl implements VisaValidator {
    ...
    public void validate(Visa visa) throws VisaValidationException {
        validate(
                ...
                visa.getDateVoyage(), visa.getDureeVoyage(), visa.getEtat()
        );
    }
    ...
    public void validate(
            ...
            Date dateNaissance, String motifVoyage, Date dateVoyage, int dureeVoyage, int etat
