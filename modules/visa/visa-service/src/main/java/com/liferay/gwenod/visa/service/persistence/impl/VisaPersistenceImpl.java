...
public class VisaPersistenceImpl
	 ...
	 */
	@Override
	public List<Visa> findByEtat(int etat) {
	 ...
	 */
	@Override
	public List<Visa> findByEtat(int etat, int start, int end) {
	...
	protected Visa getByEtat_PrevAndNext(
		Session session, Visa visa, int etat,
		OrderByComparator<Visa> orderByComparator, boolean previous) {
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByEtat = new FinderPath(
			...
			new String[] {Integer.class.getName()}, new String[] {"etat"},
			true);
