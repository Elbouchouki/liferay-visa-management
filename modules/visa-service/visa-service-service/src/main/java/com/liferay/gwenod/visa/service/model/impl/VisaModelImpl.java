...
import com.liferay.gwenod.visa.service.model.VisaModel;
...
public class VisaModelImpl extends BaseModelImpl<Visa> implements VisaModel {
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"dureeVoyage", Types.INTEGER}, {"etat", Types.VARCHAR}
	};
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"etat", (BiConsumer<Visa, String>)Visa::setEtat);
	 ...
	 */
	@Deprecated
	public String getOriginalEtat() {
		return getColumnOriginalValue("etat");
	}
	...
	public Visa cloneWithOriginalValues() {
		...
		visaImpl.setEtat(this.<String>getColumnOriginalValue("etat"));
	...
	public int compareTo(Visa visa) {
		...
		value = getEtat().compareTo(visa.getEtat());
	...
	public CacheModel<Visa> toCacheModel() {
		...
		String etat = visaCacheModel.etat;

		if ((etat != null) && (etat.length() == 0)) {
			visaCacheModel.etat = null;
		}
