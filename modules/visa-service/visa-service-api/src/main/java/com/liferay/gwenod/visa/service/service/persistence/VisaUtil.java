...
package com.liferay.gwenod.visa.service.service.persistence;
...
public class VisaUtil {
	 ...
	 * @return the matching visas
	 */
	public static List<Visa> findByEtat(String etat) {
	 ...
	 * @return the range of matching visas
	 */
	public static List<Visa> findByEtat(String etat, int start, int end) {
	 ...
	 * @param etat the etat
	 */
	public static void removeByEtat(String etat) {
	 ...
	 * @return the number of matching visas
	 */
	public static int countByEtat(String etat) {
